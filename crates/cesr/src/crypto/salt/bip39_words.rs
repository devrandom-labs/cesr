//! BIP-39 English wordlist, vendored verbatim from bitcoin/bips
//! `bip-0039/english.txt` (sha256 of the upstream newline-terminated file:
//! `2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda`).
//! Array index = upstream line order = the 11-bit value a word encodes.
//! Integrity (count, order, digest) is pinned by tests in `super::mnemonic`.

/// The 2048 BIP-39 English words, sorted ascending, `abandon` → `zoo`.
pub(super) static WORDS: [&str; 2048] = [
